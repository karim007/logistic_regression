...
# data=  np.load('data/numpy/japanes_digits/training/data.npy')
# data_test=  np.load('data/numpy/japanes_digits/test/data.npy')
# labels= np.load('data/numpy/japanes_digits/training/label.npy')
# labels_test=np.load('data/numpy/japanes_digits/test/label.npy')
# classes=10

# data=  np.load('data/numpy/persian_letters/training/data.npy')
# data_test=  np.load('data/numpy/persian_letters/test/data.npy')
# labels= np.load('data/numpy/persian_letters/training/label.npy')
# labels_test=np.load('data/numpy/persian_letters/test/label.npy')
# classes=18



logistic_regression(data, labels ,data_test ,labels_test ,classes = classes, learning_rate=1, epochs=10, stochastic_gradient_descent=True )
